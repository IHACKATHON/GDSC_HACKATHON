package org.gdsc.hackathon.config;


import lombok.RequiredArgsConstructor;
import org.gdsc.hackathon.jwt.JwtAccessDeniedHandler;
import org.gdsc.hackathon.jwt.JwtAuthenticationEntryPoint;
import org.gdsc.hackathon.jwt.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests   // HTTP 요청에 대한 인가 규칙 설정
                        .requestMatchers("/login","/signup","/googleSignup","/email/{name}","/password/{email}","/mail/*","/authenticate-firebase").permitAll()    // "/user/**"에 대한 요청은 모두에게 허용
