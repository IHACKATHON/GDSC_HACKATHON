package com.gdsc.hackathon.config;

import com.gdsc.hackathon.jwt.JwtAccessDeniedHandler;
import com.gdsc.hackathon.jwt.JwtAuthenticationEntryPoint;
import com.gdsc.hackathon.jwt.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests   // HTTP 요청에 대한 인가 규칙 설정
                        .requestMatchers("/login","/signup","/googleSignup","/email/{name}","/password/{email}","/mail/*","/authenticate-firebase","/QR","/store","/store/{id}").permitAll()    // "/user/**"에 대한 요청은 모두에게 허용
